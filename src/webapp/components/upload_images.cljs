(ns webapp.components.upload-images
  (:require [clojure.string :as str]
            [reagent.core :as r]
            [webapp.components.waterfall-row :as waterfall-row]
            [webapp.shared.ui.interaction :as interaction]
            ["react-icons/fa6" :refer [FaCamera FaFolderOpen FaImage FaPaste FaVideo]]))
...
(defn upload-images [{:keys [open on-close on-submit on-submit-many multiple? title]}]
