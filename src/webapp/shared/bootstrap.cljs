...
(defn- update-frame-motion-on-scroll! []
  (let [{:keys [last-scroll-y]} @frame-motion-state*
        ...
        next-x (max -86 (min 86 (* motion-delta 2.24 gallery-motion-translation-amplitude)))
        next-y (max -124 (min 124 (* motion-delta 3.3 gallery-motion-translation-amplitude)))
        next-rot (max -1.36 (min 1.36 (* motion-delta 0.036 gallery-motion-rotation-amplitude)))]
