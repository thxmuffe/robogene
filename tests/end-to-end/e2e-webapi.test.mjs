...
test('web API e2e: state and generate-frame flow', { skip: !shouldRun || !hasFuncCoreTools() }, async (t) => {
  ...
  try {
    ...
    if (frame2) {
      assert.ok(String(frame2.description || '').trim().length > 0, 'frame 2 description should be prefilled from services prompts');
    }
